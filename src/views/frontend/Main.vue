    ...
    <div class="content">
      ...
      <div class="container">
        ...
        <div class="row no-gutters pb-5">
          <div class="col-12 new-content-2">
            <div class="mt-5 text-center new-content move-left">
              ...
              <p
                class="mt-5"
              >BT21是由LINE FRIENDS與BTS攜手創作的卡通角色品牌，2017年發佈至今，憑藉著吸引人的魅力造型，獨特且新穎的概念和豐富多元的故事性，成長為全球年輕一代最受歡迎的角色。</p>
              <p
                class="mt-4"
              >特別的是，我們追求 “共同創造BT21”的品牌價值，與全球粉絲積極溝通並收集來自各方的意見和想法，擴展打造出更具有獨創性的BT21 UNIVERSE世界觀。</p>
            </div>
          </div>
        ...
        <div class="row no-gutters mb-5">
          <div class="col-12 new-content-2">
            <div class="mt-5 text-center new-content move-right">
              ...
              <p
                class="mt-5"
              >全球人氣卡通角色品牌LINE FRIENDS的核心關鍵詞：全球化, 千禧世代精神, 時尚潮流感，防彈少年團則是明確表現LINE FRIENDS核心關鍵詞最具代表性的藝人代表。</p>
          ...
          <div class="row mt-5 no-gutters header-background">
            ...
            <div class="col-md-7 text-center mt-5">
              <div class="new-content move-left">
                ...
                <p
                  class="mt-4"
                >最後他們認識了 KOYA, RJ, SHOOKY, MANG, CHIMMY 和 COOKY，夢想成為宇宙明星的BT21就此誕生！ 各自擁有不同魅力，在一起時更閃閃發光的BT21！ 迎著夢想奔跑的BT21他們之間發生的愉快而又感動的故事會一直繼續。</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row no-gutters pb-5">
          <div class="col-12 new-content-2">
            <div class="mt-5 text-center new-content move-left">
              <h1 class="header-title">Hot Item</h1>
              <div class="row no-gutters">
                <!-- <div class="col" v-for="(item) in hotitem" :key="item.id">
                  <div class="card shadow-sm overflow-hidden" style="width: 18rem;">
                    <div
                  class="card-img"
                  style="height: 150px; background-size: cover; background-position: center width: 100%;"
...
export default {
  ...
  methods: {
    ...
    //     vm.hotitem = products.filter(item => {
    //       return item.category === "Hot ltem";
    //     });
