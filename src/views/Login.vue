      ...
      <div class="row justify-content-center">
        <div class="col-md-5 d-flex justify-content-center">
          <div class="card login-card" style="width: 18rem;">
              <img src="https://media1.giphy.com/media/WrydB29JptO2974K4e/giphy.gif" style="height: 260px">
               <div class="card-body text-center">
               <h1 class="h3 mb-3 font-weight-normal">Please login first</h1>
               <label for="inputEmail" class="sr-only">Email address</label>
               <input type="email" id="inputEmail" v-model="user.username" class="form-control mb-2" placeholder="Email address" required>
  ...
  methods:{
     signin() {
           ...
           if (response.data.success){
             console.log("輸入成功 立刻跳轉")    
               vm.$router.push('/control/product');
         }else{
           $("#loading").css('display','none'); 
           this.$bus.$emit("message:push", "帳號或密碼有錯 請重新輸入", "danger");
         }
       })
    },
  }
